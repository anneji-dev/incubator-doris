...
#ifndef DORIS_FUNCTION_GROUPING_ID_H
#define DORIS_FUNCTION_GROUPING_ID_H
...
class FunctionGroupingId : public IFunction {
public:
    ...
    Status execute_impl(FunctionContext* context, Block& block, const ColumnNumbers& arguments,
        ...
        if (res_typeid != TypeIndex::Int64)
            return Status::InternalError("Return type is not int64 of function grouping_id");
...
#endif //DORIS_FUNCTION_GROUPING_ID_H